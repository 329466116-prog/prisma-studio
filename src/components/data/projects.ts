...
export const SERVICES = [
  {
    ...
    description:
      "End-to-end design and development of AI applications tailored to industry-specific workflows — from ideation to deployment and iteration.",
  },
  {
    id: 2,
    name: "Data Analysis",
    description:
      "Transforming raw data into actionable insights through dashboards, statistical analysis, and visualization that supports strategic decisions.",
  },
  {
    id: 3,
    name: "Intelligent Automation",
    description:
      "Building AI agents and automation pipelines that handle repetitive, multi-step tasks with reliability and clear audit trails.",
  },
  {
    id: 4,
    name: "Industry Consulting",
    description:
      "Advising teams on AI strategy, feasibility, and road-mapping — translating business goals into scoped, deliverable technical projects.",
  },
  {
    id: 5,
    name: "System Integration",
    description:
      "Connecting AI capabilities to existing enterprise systems, data sources, and tooling with attention to security and scalability.",
  },
];
