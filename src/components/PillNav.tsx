...
/**
 * PillNav: 胶囊导航栏（带 logo + 圆角悬浮涟漪 + 初始化动画）
 * Source adapted from reactbits.dev (JavaScript + CSS variant).
 * - 原版依赖 react-router-dom，本项目是单页锚点导航 → 改成纯 <a href="#xxx">
 * - logo 接受 string | ReactNode（emoji/SVG 也能用）
 * - TS 严格模式全过
 */
